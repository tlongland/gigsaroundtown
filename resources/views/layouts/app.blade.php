...
<head>
    ...
    <title>{{ config('app.name', 'gigsaroundtown') }}</title>
                        ...
                        @else
                            ...
                            <li class="dropdown">
                                <a id="drop" href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                                    {{ Auth::user()->name }} <img id="prof" class="img-circle" src="{{get_image(Auth::user()->image, "user/default.png")}}" alt=""><span class="caret"></span>
                                </a>
